...
<div class="container">
    ...
    <form action="<?php echo e(url('/empleados')); ?>" method="post" enctype="multipart/form-data">
        ...
        <?php echo $__env->make('empleados.form', ['modo' => 'Agregar'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </form>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rr..hh_DESARROLLO\resources\views/empleados/create.blade.php ENDPATH**/ ?>