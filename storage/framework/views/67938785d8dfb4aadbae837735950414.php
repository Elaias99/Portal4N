                    ...
                    <?php if($empleado): ?>
                        ...
                        <div class="text-center mb-2">
                            ...
                            <small class="text-muted">
                                <?php echo e(optional($empleado->cargo)->Nombre ?? 'Sin cargo'); ?>
        ...
        <div id="mainContent" class="col-md-9">
            ...
            <div id="section-resumen" class="content-section">
                <div class="row mt-4 justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="stat-card p-4 text-center shadow-lg">
                            ...
                            <h2 class="fw-bold text-primary"><?php echo e($empleadosConSaldoCount); ?></h2>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="stat-card p-4 text-center shadow-lg">
                            ...
                            <?php endif; ?>
                            <h2 class="fw-bold text-primary"><?php echo e($empresa->trabajadores_count); ?></h2>
                        </div>
                    </div>
                ...
                <div class="container mt-4">
                    ...
                    <div class="row">
                        <?php $__currentLoopData = $cargosChunked; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4">
                            <ul class="list-group list-group-flush">
                                <?php $__currentLoopData = $grupo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cargo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="list-group-item d-flex justify-content-between">
                                    <span><?php echo e($cargo->Nombre); ?></span>
                                    <span class="fw-bold text-primary"><?php echo e($cargo->trabajadors_count); ?></span>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
            ...
            <div id="section-asistencia" class="content-section d-none">
                <div class="text-center p-4">
                    ...
                    <a href="<?php echo e(route('asistencia.index')); ?>" class="btn btn-primary">Ir a Marcar Asistencia</a>
                    ...
                    <ul class="list-group">
                        <?php $__currentLoopData = $solicitudesPendientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $solicitud): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item">
                                <?php echo e($solicitud->trabajador->Nombre); ?> - <?php echo e($solicitud->campo); ?>
            ...
            <div id="section-nuevos" class="content-section d-none">
                ...
                <?php if(!$hayEmpleadosNuevos): ?>
                    <p class="text-muted">No hay nuevos empleados en el último mes.</p>
                <?php else: ?>
                    <ul class="list-group">
                        <?php $__currentLoopData = $empleadosNuevos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empleado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item">
                                <?php echo e($empleado->Nombre); ?> - <?php echo e($empleado->cargo->Nombre); ?>
            ...
            <div id="section-desvinculados" class="content-section d-none">
                ...
                <?php if(!$hayEmpleadosDesvinculados): ?>
                    <p class="text-muted">No hay empleados desvinculados.</p>
                <?php else: ?>
                    <ul class="list-group">
                        <?php $__currentLoopData = $empleadosDesvinculados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empleado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item">
                                <?php echo e($empleado->Nombre); ?> <?php echo e($empleado->ApellidoPaterno); ?> - 
                                <?php echo e($empleado->cargo->Nombre ?? 'Sin cargo'); ?>
        ...
        document.querySelector('[data-section="asistencia"]').addEventListener('click', function () {
            ...
            if (!calendar) {
                calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    events: [
                        <?php $__currentLoopData = $vacacionesAprobadas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacacion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        {
                            title: '<?php echo e(trim($vacacion->trabajador->Nombre . " " . $vacacion->trabajador->ApellidoPaterno)); ?> (Hasta: <?php echo e(\Carbon\Carbon::parse($vacacion->fecha_fin)->format("d/m/Y")); ?>)',
                            start: '<?php echo e($vacacion->fecha_inicio); ?>',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rr..hh_DESARROLLO\resources\views/dashboard/index.blade.php ENDPATH**/ ?>