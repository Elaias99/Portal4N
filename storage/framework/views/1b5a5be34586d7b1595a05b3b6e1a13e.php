...
<div class="form-group">
    ...
    <input type="text" name="razon_social" id="razon_social" class="form-control"
           value="<?php echo e(old('razon_social', $proveedor->razon_social ?? '')); ?>" required
...
<div class="form-group">
    ...
    <input type="text" name="rut" id="rut" class="form-control"
           value="<?php echo e(old('rut', $proveedor->rut ?? '')); ?>" required
...
<div class="form-group">
    ...
    <input type="text" name="telefono_empresa" id="telefono_empresa" class="form-control"
           value="<?php echo e(old('telefono_empresa', $proveedor->telefono_empresa ?? '')); ?>" required
...
<div class="form-group">
    ...
    <input type="text" name="giro_comercial" id="giro_comercial" class="form-control"
           value="<?php echo e(old('giro_comercial', $proveedor->giro_comercial ?? '')); ?>" required
...
<div class="form-group">
    ...
    <input type="text" name="direccion_facturacion" id="direccion_facturacion" class="form-control"
           value="<?php echo e(old('direccion_facturacion', $proveedor->direccion_facturacion ?? '')); ?>"
...
<div class="form-group">
    ...
    <input type="text" name="direccion_despacho" id="direccion_despacho" class="form-control"
           value="<?php echo e(old('direccion_despacho', $proveedor->direccion_despacho ?? '')); ?>"
...
<div class="form-group">
    ...
    <input type="text" name="comuna_empresa" id="comuna_empresa" class="form-control"
           value="<?php echo e(old('comuna_empresa', $proveedor->comuna_empresa ?? '')); ?>"
...
<div class="form-group">
    ...
    <input type="text" name="Nombre_RepresentanteLegal" id="Nombre_RepresentanteLegal" class="form-control"
           value="<?php echo e(old('Nombre_RepresentanteLegal', $proveedor->Nombre_RepresentanteLegal ?? '')); ?>"
...
<div class="form-group">
    ...
    <input type="text" name="Rut_RepresentanteLegal" id="Rut_RepresentanteLegal" class="form-control"
           value="<?php echo e(old('Rut_RepresentanteLegal', $proveedor->Rut_RepresentanteLegal ?? '')); ?>"
...
<div class="form-group">
    ...
    <input type="text" name="Telefono_RepresentanteLegal" id="Telefono_RepresentanteLegal" class="form-control"
           value="<?php echo e(old('Telefono_RepresentanteLegal', $proveedor->Telefono_RepresentanteLegal ?? '')); ?>"
...
<div class="form-group">
    ...
    <input type="email" name="Correo_RepresentanteLegal" id="Correo_RepresentanteLegal" class="form-control"
           value="<?php echo e(old('Correo_RepresentanteLegal', $proveedor->Correo_RepresentanteLegal ?? '')); ?>"
...
<div class="form-group">
    ...
    <input type="text" name="contacto_nombre" id="contacto_nombre" class="form-control"
           value="<?php echo e(old('contacto_nombre', $proveedor->contacto_nombre ?? '')); ?>"
           placeholder="Nombre del contacto">
</div>
<div class="form-group">
    <label for="contacto_telefono">Teléfono</label>
    <input type="text" name="contacto_telefono" id="contacto_telefono" class="form-control"
           value="<?php echo e(old('contacto_telefono', $proveedor->contacto_telefono ?? '')); ?>"
...
<div class="form-group">
    ...
    <input type="email" name="contacto_correo" id="contacto_correo" class="form-control"
           value="<?php echo e(old('contacto_correo', $proveedor->contacto_correo ?? '')); ?>"
           placeholder="Correo del contacto">
</div>
<div class="form-group">
    <label for="cargo_contacto1">Cargo</label>
    <input type="text" name="cargo_contacto1" id="cargo_contacto1" class="form-control"
           value="<?php echo e(old('cargo_contacto1', $proveedor->cargo_contacto1 ?? '')); ?>"
...
<div class="form-group">
    ...
    <input type="text" name="nombre_contacto2" id="nombre_contacto2" class="form-control"
           value="<?php echo e(old('nombre_contacto2', $proveedor->nombre_contacto2 ?? '')); ?>"
...
<div class="form-group">
    ...
    <input type="text" name="telefono_contacto2" id="telefono_contacto2" class="form-control"
           value="<?php echo e(old('telefono_contacto2', $proveedor->telefono_contacto2 ?? '')); ?>"
...
<div class="form-group">
    ...
    <input type="email" name="correo_contacto2" id="correo_contacto2" class="form-control"
           value="<?php echo e(old('correo_contacto2', $proveedor->correo_contacto2 ?? '')); ?>"
...
<div class="form-group">
    ...
    <input type="text" name="cargo_contacto2" id="cargo_contacto2" class="form-control"
           value="<?php echo e(old('cargo_contacto2', $proveedor->cargo_contacto2 ?? '')); ?>"
...
<div class="form-group">
    ...
    <select name="banco" id="banco" class="form-control">
        <?php $__currentLoopData = ['Banco Estado', 'Santander', 'Bci', 'Efectivo', 'Banco Chile', 'Banco Falabella', 'Banco BICE',
        'Banco Consorcio', 'Banco Scotiabank', 'Banco Security','Banco Corpbanca','Banco Ripley','Banco Itau','Banco Paris','Banco del Desarrollo',
        'Banco Copeuch','Banco BBVA','Web pago Online','Mercado Pago','Tenpo','Banco Edwars','Efectivo']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($banco); ?>" <?php echo e(old('banco', $proveedor->banco ?? '') == $banco ? 'selected' : ''); ?>>
                <?php echo e($banco); ?>
...
<div class="form-group">
    ...
    <input type="text" name="nro_cuenta" id="nro_cuenta" class="form-control"
           value="<?php echo e(old('nro_cuenta', $proveedor->nro_cuenta ?? '')); ?>" required
...
<div class="form-group">
    ...
    <select name="tipo_cuenta" id="tipo_cuenta" class="form-control">
        <?php $__currentLoopData = ['Cuenta Corriente', 'Cuenta Vista', 'Cuenta Rut' ,'Ahorro']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo_cuenta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($tipo_cuenta); ?>" <?php echo e(old('tipo_cuenta', $proveedor->tipo_cuenta ?? '') == $tipo_cuenta ? 'selected' : ''); ?>>
                <?php echo e($tipo_cuenta); ?>
...
<div class="form-group">
    ...
    <input type="email" name="correo_banco" id="correo_banco" class="form-control"
           value="<?php echo e(old('correo_banco', $proveedor->correo_banco ?? '')); ?>"
...
<div class="form-group">
    ...
    <select name="tipo_pago" id="tipo_pago" class="form-control">
        <?php $__currentLoopData = ['Transferencia', 'Cheque', 'Efectivo']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metodo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($metodo); ?>" <?php echo e(old('tipo_pago', $proveedor->tipo_pago ?? '') == $metodo ? 'selected' : ''); ?>>
                <?php echo e($metodo); ?>
...
<div class="form-group">
    ...
    <input type="text" name="nombre_razon_social_banco" id="nombre_razon_social_banco" class="form-control"
           value="<?php echo e(old('nombre_razon_social_banco', $proveedor->nombre_razon_social_banco ?? '')); ?>"
           placeholder="Razón social del titular de la cuenta bancaria">
</div>



<?php /**PATH C:\xampp\htdocs\rr..hh_DESARROLLO\resources\views/proveedores/form.blade.php ENDPATH**/ ?>