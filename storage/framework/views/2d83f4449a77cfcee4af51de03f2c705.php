                                ...
                                <div class="accordion-body">
                                    <?php $__currentLoopData = $region->comunas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comuna): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="comuna_id" id="comuna_<?php echo e($comuna->id); ?>" value="<?php echo e($comuna->id); ?>" <?php echo e(old('comuna_id', $empleado->comuna_id ?? '') == $comuna->id ? 'checked' : ''); ?>>                                            
                                            <label class="form-check-label" for="comuna_<?php echo e($comuna->id); ?>">
                                                <?php echo e($comuna->Nombre); ?>
...
<?php /**PATH C:\xampp\htdocs\rr..hh_DESARROLLO\resources\views/partials/comunas_modal.blade.php ENDPATH**/ ?>