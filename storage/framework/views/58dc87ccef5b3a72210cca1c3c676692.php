            ...
            <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="dropdown-item d-flex align-items-start notification-item">
                    ...
                    <div class="notification-text">
                        ...
                        <a href="<?php echo e(route('notifications.markAsRead', $notification->id)); ?>" class="text-decoration-none">
                            <p class="mb-0 fw-bold"><?php echo e($notification->data['mensaje']); ?></p>
                        </a>
...
<?php /**PATH C:\xampp\htdocs\rr..hh_DESARROLLO\resources\views/components/notifications-dropdown.blade.php ENDPATH**/ ?>