...
<div class="container">
    ...
    <a href="{{ route('clasificacion-operativa.index') }}" class="btn btn-primary mb-3" style="background-color: #007bff; border-color: #007bff; font-size: 16px; padding: 10px 20px; border-radius: 5px;">
             Operadores
    </a>

    <a href="{{ route('comunas.export') }}" class="btn btn-success mb-3" style="font-size: 16px; padding: 10px 20px; border-radius: 5px;">
