{{-- resources/views/cotizadores/modal_maquilado_transporte.blade.php --}}

<div class="modal fade" id="modalMaquilaTransporte" tabindex="-1" aria-labelledby="modalMaquilaTransporteLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">

      {{-- Header --}}
      <div class="modal-header">
        <h5 class="modal-title" id="modalMaquilaTransporteLabel">Transporte asociado a Maquila</h5>
      ...
      <div class="modal-body">
        ...
        {{-- Lleva pioneta --}}
        <div class="mb-3">
            <label for="lleva_pioneta" class="form-label">¿Lleva pioneta?</label>
        ...
        <div id="detallePionetaWrapper" class="d-none">
            <div class="mb-3">
                <label for="cantidad_pionetas" class="form-label">Cantidad de pionetas</label>
                <input type="number" name="cantidad_pionetas" id="cantidad_pionetas" class="form-control" min="1">
            </div>
            <div class="mb-3">
                <label for="jornada_pioneta" class="form-label">Jornada del pioneta</label>
