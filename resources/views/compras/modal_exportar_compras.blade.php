<div class="modal fade" id="modalExportarCompras" tabindex="-1" aria-labelledby="modalExportarCompras" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content shadow">

                <div class="modal-header bg-white border-bottom">
                    <h5 class="modal-title" id="modalExportarCompras">
                    Exportar listado Compras
                    </h5>
                    <button type="button"
                ...
                <form action="{{ route('compras.exportar') }}" method="GET">
                    <div class="modal-body">
                        <p class="text-muted mb-3">Selecciona los campos que deseas incluir en la exportación:</p>
