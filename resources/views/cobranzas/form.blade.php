...
<div class="mb-3">
    ...
    <input type="text" name="rut_cliente" id="rut_cliente" 
           ...
           value="{{ old('rut_cliente', $cobranza->rut_cliente ?? '') }}" required>
    @error('rut_cliente')
...
<div class="mb-3">
    ...
    <input type="text" name="razon_social" id="razon_social" 
           ...
           value="{{ old('razon_social', $cobranza->razon_social ?? '') }}" required>
    @error('razon_social')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
...
<div class="mb-3">
    ...
    <input type="text" name="servicio" id="servicio" 
           ...
           value="{{ old('servicio', $cobranza->servicio ?? '') }}" required>
    @error('servicio')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
...
<div class="mb-3">
    ...
    <input type="number" name="creditos" id="creditos" min="0"
           ...
           value="{{ old('creditos', $cobranza->creditos ?? '') }}" required>
    @error('creditos')
        <div class="invalid-feedback">{{ $message }}</div>
    @enderror
</div>
