    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            @component('layouts.columna_izquierda', [
                ...
                'tituloFiltros' => 'Filtrar Estado',
                'action' => route('solicitudes.vacaciones')
            ])
                @slot('acciones')
                    <div class="d-grid gap-2">
                        <a href="{{ route('rrhh.formulario') }}" class="btn btn-outline-danger text-start" data-bs-toggle="tooltip" title="PDF Manual">
                            <i class="fas fa-file-pdf me-2"></i> PDF Manual
                        </a>
                        <a href="{{ route('historial-vacacion.index') }}" class="btn btn-outline-secondary text-start" data-bs-toggle="tooltip" title="Historial">
                            <i class="fas fa-history me-2"></i> Historial
                        </a>
                        <a href="{{ route('vacaciones.exportarDisponibles') }}" class="btn btn-outline-success text-start" data-bs-toggle="tooltip" title="Exportar Excel">
        ...
        <!-- Columna derecha (tarjetas de solicitudes) -->
        <div class="col-lg-10">
            <div class="row">
