...
<div class="page">
    ...
    <div class="container">
        ...
        <div class="signature-section" style="display: flex; flex-direction: column; align-items: center; gap: 5px;">
            <div class="signature" style="font-size: 12px; margin-bottom: 3px;">
            ...
            <div class="signature" style="margin-top: 5px;">
                @if(isset($firmaPath) && file_exists($firmaPath))
                    <img src="{{ $firmaPath }}" alt="Firma del Jefe" style="width: 180px; height: auto; margin-bottom: 3px;">
                @else
                    _______________________________ <br>
                @endif
