...
class HonorarioMensualRecController extends Controller
{
    ...
    protected HonorarioMensualStoreService $honorarioMensualStoreService;

    public function __construct(
        HonorarioMensualImportService $honorarioMensualImportService,
        HonorarioMensualStoreService $honorarioMensualStoreService
    ) {
        $this->honorarioMensualImportService = $honorarioMensualImportService;
        $this->honorarioMensualStoreService = $honorarioMensualStoreService;
    }
    ...
    public function store(Request $request)
    {
        ...
        $guardadoOk = $this->honorarioMensualStoreService->execute($data);
